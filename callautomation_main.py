...
ACS_CONNECTION_STRING = _config.ACS_CONNECTION_STRING

# Your ACS resource phone number will act as source number to start outbound call
ACS_PHONE_NUMBER = _config.ACS_PHONE_NUMBER

# Target phone number you want to receive the call.
TARGET_PHONE_NUMBER = _config.TARGET_PHONE_NUMBER

# Callback events URI to handle callback events.
# CALLBACK_URI_HOST = _config.CALLBACK_URI_HOST_WITH_PROTOCOL
CALLBACK_URI_HOST = _config.CALLBACK_URI_HOST
CALLBACK_EVENTS_URI = CALLBACK_URI_HOST + "/api/callbacks"
COGNITIVE_SERVICES_ENDPOINT = _config.COGNITIVE_SERVICES_ENDPOINT

#(OPTIONAL) Your target Microsoft Teams user Id ex. "ab01bc12-d457-4995-a27b-c405ecfe4870"
TARGET_TEAMS_USER_ID = _config.TARGET_TEAMS_USER_ID

TEMPLATE_FILES_PATH = "_samples/callautomation/template"
